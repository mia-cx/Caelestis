...
- [ ] Reject closed, foreign, non-Dependabot, and stale PR selections before candidate code runs.
- [ ] Run userscript/shared/UI checks and the extended portable and Cloudflare acceptance suites.
- [ ] Publish a commit status with the run link; require every suite to succeed.
- [ ] Keep production credentials, publication, and deployment outside this workflow.
...
- [ ] Connect reusable validation workflows and test their routing and permissions.
