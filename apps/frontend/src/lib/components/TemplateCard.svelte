...
<a
  ...
  class="group flex flex-col overflow-hidden rounded-2xl border-2 border-base-300 bg-base-100 focus-visible:outline-2 focus-visible:outline-primary"
>
  <div class="flex h-44 justify-center overflow-hidden border-b-2 border-base-300">
