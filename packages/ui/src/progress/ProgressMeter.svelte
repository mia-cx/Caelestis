...
<style>
  ...
  .percent { flex: 0 0 5ch; min-inline-size: 0; text-align: end; font-family: inherit; font-size: 0.75rem; font-weight: 700; line-height: 1; font-variant-numeric: tabular-nums; }
